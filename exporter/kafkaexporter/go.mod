...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/batchpersignal v0.136.0
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/kafka/configkafka v0.136.0
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/kafka/topic v0.136.0
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/translator/zipkin v0.136.0
	...
	go.opentelemetry.io/collector/exporter/exporterhelper/xexporterhelper v0.136.0
	go.opentelemetry.io/collector/exporter/exportertest v0.136.0
	go.opentelemetry.io/collector/exporter/xexporter v0.136.0
