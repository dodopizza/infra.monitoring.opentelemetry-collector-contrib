...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/healthcheck v0.136.0
...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/status v0.136.0 // indirect
